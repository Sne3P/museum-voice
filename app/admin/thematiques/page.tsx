...
export default function ThematiquesPage() {
  ...
  const handleImageUpload = async (file: File, type: 'centre' | 'mouvement') => {
    const setUploading = type === 'centre' ? setIsUploadingCentre : setIsUploadingMouvement
    const setSelectedImage = type === 'centre' ? setSelectedCentreImage : setSelectedMouvementImage
